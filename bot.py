...
async def start(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text(
    f"Great, {name}!\n\n"
    "Start the test. Choose the picture that was NOT generated by artificial intelligence. "
    "Recraft gave us some quality content. This is just a warm-up before the prize draw begins on May 1st.✅\n\n"
    "You have ⚠️15 seconds⚠️ to make your choice — to prevent image search abuse. "
    "There will be even less time during the draw. But you’ve got this.😊\n"
    "If you’re aiming to WIN A MONTHLY ChatGPT Plus SUBSCRIPTION, all the info is in the blue Menu button.\n\n"
    "— — — — — — — — — — — — — — — — — — — —\n\n"
    f"Отлично, {name}!\n\n"
    "Начинаем тест. Выберите картинку, которая сделана фотографом, а не искусственным интеллектом. "
    "Recraft подготовил качественный контент. Это всего лишь разминка перед розыгрышем призов 1 мая.✅\n\n"
    "Время выбора ⚠️15 секунд⚠️ — чтобы избежать поиска картинок в интернете. "
    "Во время розыгрыша времени будет ещё меньше. Но вы справитесь.😊\n"
    "Если хотите ВЫИГРАТЬ МЕСЯЧНУЮ ПОДПИСКУ ChatGPT Plus, "
    "вся информация находится в синей кнопке Меню. ⬇\n\n"
    f"{stats_text}",
